...
*   **Maximum Motor Current:**
    *   **Continuous:** 10A **per channel**
    *   **Peak (< 10 seconds):** 30A **per channel**
    > 💡 **Beginner safety note:** Even though the board supports high current, beginners should always test with wheels lifted and start at low speed first.
*   **Logic Outputs:**
    *   +5V: 1000mA max.
    *   +3.3V: 500mA max.
    *   I/O Pin: 20mA max.
...
## 13. Resolved Advisories (Human Review Complete)

*   **[RESOLVED] Sumo Rule Compliance:** Standard sumo competitions often require a mandatory **5-second delay** after the button press. The sample code only implements a **1-second delay**. A note has been added to all code examples and tutorial-summary.md.
*   **[RESOLVED] Pin Multiplexing:** Using the secondary HC-SR04 ultrasonic port (Sensor 2) will conflict with the Right Edge and Right Opponent sensors. Both cannot be used simultaneously. This is documented in pin-map.md and hardware-setup.md.
*   **[RESOLVED] Microcontroller:** Confirmed as ATmega328P. Updated in product-context.md and source-audit.md.
*   **[RESOLVED] Current Limit:** Confirmed as 10A continuous / 30A peak **per channel**. Updated in product-context.md, hardware-setup.md, safety-rules.md, and source-audit.md.
